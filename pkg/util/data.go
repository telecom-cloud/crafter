...
func PackArgs(c interface{}) (res []string, err error) {
	...
	if t.Kind() != reflect.Struct {
		return nil, errors.New("passed arg must be struct or pointer of struct")
	}
...
func UnpackArgs(args []string, c interface{}) error {
	...
	if t.Kind() != reflect.Struct {
		return errors.New("passed arg must be struct or pointer of struct")
	}
